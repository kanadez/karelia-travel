...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru" id="laki-hotel-ru">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="css/dropdown_dark.css" />
   ...
   <body id="page">
      <div id="wrapper_div" class="container">
         ...
         <div id="content_div" >
            <div id="index_welcome_header_div" style="color:#fff !important"><?php echo $constructor->getContent("mainpage", "title"); ?></div>
            <p><div id="index_welcome_content_div" style="color:#fff !important">
               <?php echo $constructor->getContent("mainpage", "uto"); ?>
            </div>
            <a id="search_tour" class="sbmt" href="search.php">НАЙТИ ТУР</a>
            <a id="show_all_tours" class="sbmt" href="tours.php">ПОКАЗАТЬ ВСЕ ТУРЫ</a>
         </div>
      </div>
