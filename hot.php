...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru" id="laki-hotel-ru">
   ...
   <body id="page">
      <div id="wrapper_div" class="container">
         ...
         <?php echo $constructor->getWhiteHeader("hot"); ?>
         
         <div id="content_div">
            <div id="breadcrumbs_div" style="float:left"><a href="tours.php">Все туры</a> ❯ <a href="hot.php">Горящие туры</a></div>
            <div style="clear:both"></div>
            
            <h3 style="width:100%; text-align:center;color:#333">Горящие туры</h3>
            <?php echo $tour->getHot(!isset($_GET["page"]) ? 1 : $_GET["page"]); ?>
         </div>
      </div>
