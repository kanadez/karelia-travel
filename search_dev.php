...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru" id="laki-hotel-ru">
   ...
   <body id="page">
      <div id="wrapper_div" class="container">
         ...
         <div id="content_div">
            <h3 style="width:100%; text-align:center;color:#333">Поиск тура</h3>
            <div style="margin-top:15vh;margin-bottom:25vh;width:100%; text-align:center">
               Где будем искать?
               <p style="margin-top:30px"></p>
               <a href="search_local.php" style="padding: 13px 44px;" class="orange_link">Туры по Карелии</a>
               <a href="search_global.php" style="padding: 13px 44px; margin-left: 20px;" class="blue_button">Туры по России</a>
            </div>
         </div>
      </div>
